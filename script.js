...
function toggle() {
    if (mode == 0) {
        mode = 1;
        document.getElementById("button").style.translate = "40px"
        document.getElementById("button").style.background = "black"
        document.getElementById("toggle").style.background = "white"
        document.getElementById("toggle").style.border = "8px solid white"
        ...
        document.getElementById("toggle").style.border = "8px solid black"
